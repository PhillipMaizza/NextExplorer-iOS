...
public struct FileItem: Codable, Equatable, Identifiable, Sendable {
    ...
    private var lowercaseKind: String {
        kind.lowercased()
    }

    public var isImage: Bool {
        Self.isImageKind(kind)
    }
    ...
    public var isRawImage: Bool {
        Self.isRawImageKind(kind)
    }

    public var isVideo: Bool {
        Self.isVideoKind(kind)
    }

    public var isAudio: Bool {
        Self.isAudioKind(kind)
    }

    public var isArchive: Bool {
        Self.isArchiveKind(kind)
    }
    ...
    public var isBrowsableArchive: Bool {
        lowercaseKind == "zip" || lowercaseKind == "rar"
    }
    ...
    /// once already.
    public var isOfficeDocument: Bool {
        Self.officeDocumentExtensions.contains(lowercaseKind)
    }
    ...
    public var isHTML: Bool {
        lowercaseKind == "html" || lowercaseKind == "htm"
    }
    ...
    /// `GoogleDocsPointer`.
    public var isGoogleDocsPointer: Bool {
        GoogleDocsPointer.isPointerKind(kind)
    }

    public static func isImageKind(_ kind: String) -> Bool {
        imageExtensions.contains(kind.lowercased())
    }

    public static func isRawImageKind(_ kind: String) -> Bool {
        rawImageExtensions.contains(kind.lowercased())
    }

    public static func isVideoKind(_ kind: String) -> Bool {
        videoExtensions.contains(kind.lowercased())
    }

    public static func isAudioKind(_ kind: String) -> Bool {
        audioExtensions.contains(kind.lowercased())
    }

    public static func isArchiveKind(_ kind: String) -> Bool {
        archiveExtensions.contains(kind.lowercased())
    }
    ...
    public var isStreamableMedia: Bool {
        isVideo || isAudio
    }
    ...
    /// `isOfficeDocument`.
    public var isPreviewableViaDownload: Bool {
        isImage || isRawImage || lowercaseKind == "pdf" || isOfficeDocument
    }
